let UIController = (() => {
    ...
    return {
        ...
        setCountry(country) {
            ...
            document.querySelector(HTMLStrings.countryDiv).innerHTML = '<img src="https://www.countryflags.io/' + getCountryFlag(country) + '/flat/32.png"> <span class="country-name">' + country + '</span>'
        },
